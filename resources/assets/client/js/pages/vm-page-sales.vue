<template>
    <vm-page-list :hasPagination="true" :hasFilters="true" v-model="filter"
                  :isProcessing="typesFilter.ajax.isProcessing">
...
<script>
    ...
    import salesFilter from '../instances/salesFilter'
    ...
    export default {
        ...
        watch: {
            "$route.params.id"() {
                ...
                this.filter.query.is_sale = true
