                                    ...
                                    <vm-form-group>
                                        ...
                                        <template scope="props">
                                            <vm-categories-select
                                                    v-model="filter.query.category"
                                                    :id="props.id"
                                            ></vm-categories-select>
                                        </template>
                                    </vm-form-group>
                                    <vm-form-group>
                                        <span slot="label">Is Sale</span>
                                        <template scope="props">
                                            <input v-model="filter.query.is_sale" :id="props.id" type="checkbox" title="Is Sale">
                                        </template>
                                    </vm-form-group>
        ...
        methods: {
            search(){
                ...
                this.filter.search({holding: true}).then((data)=>{
                    this.filter.data = this.filter.populateMany(data, Product)
                }).catch(()=>{

                })
            },
            addItem(){
                this.pickItem(new Product())
            },
            pickItem(item){
                this.formIsDanger = false;
