                            ...
                            <form role="form" @input="search">
                                <div class="form-group">
                                    ...
                                    <vm-form-group>
                                        ...
                                        <template scope="props">
                                            <input v-model="filter.query.title_like" :id="props.id" class="form-control" type="text" title="Title">
                                        </template>
                                    </vm-form-group>
                                    <vm-form-group>
        ...
        methods: {
            search(){
                ...
                this.filter.search({holding: true}).then((data)=>{
                    this.filter.data = this.filter.populateMany(data, Type)
                }).catch(()=>{

                })
            },
            addItem(){
                this.pickItem(new Type())
            },
            pickItem(item){
                this.formIsDanger = false;
